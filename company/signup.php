                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-4 pb-2">
                                                    ...
                                                    <div class="form-outline">
                                                        <input type="text" id="form3Examplev2"
                                                            ...
                                                            name="com_name" />
                                                        <label class="form-label" for="form3Examplev2">Company
                                                            Name</label>
                                                    </div>
                                                ...
                                                <div class="col-md-6 mb-4 pb-2">
                                                    ...
                                                    <div class="form-outline">
                                                        <input type="number" id="form3Examplev3" name="contact"
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="row">
                                                <div class="col-md-5 mb-4 pb-2">
                                                    ...
                                                    <div class="form-outline form-white">
                                                        <input type="number" id="form3Examplea4" min="50" max="300"
                                                            name="fix_c" class="form-control form-control-lg"
                                                            required="required" />
                                                ...
                                                <div class="col-md-7 mb-4 pb-2">
                                                    ...
                                                    <div class="form-outline form-white">
                                                        <input type="text" id="form3Examplea5" name="com_aadhaar"
                                                            class="form-control form-control-lg" required="required" />
                                            ...
                                            <div class="mb-4 pb-2">
                                                <div class="form-outline form-white">
                                                    <label class="form-label" style="color:white">Upload Company Photo
                                                    </label>
