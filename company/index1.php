...
<body>
    ...
    //{
        ...
        $sql = "SELECT * FROM `book_master` WHERE `com_email` = '".$user_id."' AND `status` =1 AND `status` =2";
    ...
    <div class="container py-lg-5">
        <?php //echo $sql;exit;
            while($row2 = mysqli_fetch_array($run_sql))
                {//echo $query;exit;?>
        <a href="view_order1.php?emp_detail=<?php echo $row2['book_id'];?>" style="dispaly:block;">
