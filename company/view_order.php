                        ...
                        <tr>
                            ...
                            <td style="vertical-align:top">
                                <input class="btn" style="background-color:aqua;color:black;" type="submit"
                                    value="Assign Worker" data-toggle="modal" data-target="#myModal">
                            </td>
                        </tr>
                        <!-- </section> -->
                    </table>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <table style="width:100%;">
                    <th style="height:50px;"><h4 style="color:blue;">Worker Name</h4></th>
                        <th><h4 style="color:blue;">Worker Email</h4></th>
                        <th><h4 style="color:blue;">Assign Worker</h4></th>
                        <?php
                        ...
                        <tr style="height:50px;">
                            ...
                            ?>
                            <td>
                                <a href="assign_worker.php?worker_email=<?php echo $row4['wor_email'];?> && assign_id=<?php echo $_GET['emp_detail'];?>"><input type="button" value="Assign" style="width:80px;height:35px;background:#ffab2d;color:#ffffff;border:0px;border-radius:6px;padding:5px 7px;font-family:Rubik,sans-serif;font-size: 15px;"></a>
                            </td>
                        </tr>
                        <?php
                            }
