                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content pt-3">
                                <div class="tab-pane active">
                                    <form class="form" method="POST" action="edit_profile1.php">
                                        <div class="row">
                                            <div class="col">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <label>Name</label>
                                                            <input class="form-control" type="text" name="wor_name"
                                                                value="<?php echo $user['wor_name'];?>">
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <label>Gender</label>
                                                            <input class="form-control" type="text" name="wor_contact"
                                                                value="<?php echo $user['wor_contact'];?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <label>Email</label>
                                                            <input class="form-control" type="text" name="wor_email"
                                                                value="<?php echo $user['wor_email'];?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <label>Address</label>
                                                            <input class="form-control" type="text" name="wor_address"
                                                                value="<?php echo $user['wor_address'];?>">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <?php
                                                                $sql1="SELECT * FROM area_master WHERE `city_id`='".$user['wor_city']."'";
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <label>Area</label>
                                                            <select id="city" name="area" class="form-control"
                                                                style="color:black;">
                                                                <?php
                                                            if($result1->num_rows > 0){ 
                                                                ...
                                                                <option value="<?= $row['area_name'];?>"
                                                                    <?php if($row['area_name']==$user['wor_area']){echo "selected";} ?>>
                                                                    <?= $row['area_name'];?></option> <?php  
                                                            }
                                                            }
                                                                        ?>
                                                            </select>
                                                ...
                                                <div class="row">
                                                    <div class="col mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="hidden" name="worker_id"
                                                                value="<?php echo $user['worker_id'];?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
