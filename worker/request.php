...
<body>
    ...
    <?php
		...
		$sql="SELECT * FROM book_master WHERE wor_email='".$to_id."' AND status=0";
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-3 w-100">
                            ...
                            <div class="button mt-2 d-flex flex-row align-items-center">
                                <a href="accept_request1.php?wor_email=<?php echo $row['wor_email'];?>&& book_id=<?php echo $row['book_id'];?> "><input
                                ...
                                <a href="delete_request1.php?wor_email=<?php echo $row['wor_email'];?>&& book_id=<?php echo $row['book_id'];?> ""><input
