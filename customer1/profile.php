                                        ...
                                        <div class="e-profile">
                                            ...
                                            <div class="tab-content pt-3">
                                                <div class="tab-pane active">
                                                    <form class="form" action="update_profile.php">
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <div class="form-group">
                                                                            <label>Name</label>
                                                                            <label
                                                                                class="form-control"><?php echo $user['name'];?></label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <label
                                                                                class="form-control"><?php echo $user['contact'];?></label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <div class="form-group">
                                                                            <label>Email</label>
                                                                            <label
                                                                                class="form-control"><?php echo $user['email'];?></label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="text-left">
                                                                <a onclick="myFunction()"><button
                                                                        class="btn submit btn-secondary" style="background-color:orange;border-color:orange;margin-left:20px;">
