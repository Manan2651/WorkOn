<?php
    $query1="SELECT * FROM book_master WHERE `cost_email`='".$_SESSION['cost_logged_in']."' AND `self`=1";
    // echo $query1;exit;
                        ...
                        <table>
                            <tr>
                                <td style="vertical-align:center;width:30%">
                                    Worker Name:<p class="card-text" style="text-transform:capitalize;">
                                        <?php echo $row5['wor_name']; ?></p>
                                ...
                                <td style="width:60%">
                                    ...
                                    {
                                        echo "<h4>Worker has accepted your request and <br>Give OTP to worker.</h4>";
                                    }
                                    else if($row5['status'] == 2)
                                    {
                                        echo "<h4>Declined By Worker.</h4>";
                                    }
