...
<body>
    ...
    <section class="w3l-content-with-photo-4">
        ...
        <a class=" btn btn-primary mb-2" href="services.php"><i class="fa fa-arrow-left"><input class="btn btn-primary" type="submit" value="Back"></i></a>    <!-- Modal -->
        ...
        $sql1 = "SELECT * FROM `company_master_table1` WHERE `company_id` = '".$com_id."'";
        ...
        if($run_sql !== FALSE)
        {
            ...
            <div class="grid contact-grids row">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-auto mb-3">
                                            <div class="mx-auto" style="width: 160px;">
                                                ...
                                                <img src="../company/<?php echo $user['profile_pic'];?>" alt="profile"
                                        ...
                                        <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                                            <div class="text-center text-sm-left mb-2 mb-sm-0">
                                                ...
                                                $sql3="SELECT * FROM `rate` WHERE `email`='".$user['email']."'";
                                                ...
                                                <!-- <a class="mb-0 ml-5" href="services.php"><input
                                                        class="btn btn-primary mb-2" type="submit" value="Back"></a> -->
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                <label>Skills</label>
                                                                <label
                                                                    class="form-control"><?php echo $user['skill_list'];?>
                                                                    </lable>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                $query1="SELECT * FROM city_master WHERE city_id='".$user['city']."'";
                ...
                <div class="col-12 col-md-3 mb-3">
                    ...
                    <!-- <div class="col-12 col-md-3 mb-3"> -->
                    <?php
                    $sql2="SELECT * FROM bookmark_master WHERE from_id='".$_SESSION['cost_logged_in']."' AND com_id='".$email."'";
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="px-xl-3">
                                <a href="unbookmark.php?com_email=<?php echo $email; ?>&&com_id=<?php echo $user['company_id']; ?>" class="btn btn-block" style="color:black;border-color:black;">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <h4 style="margin-left:50px;">Bookmark</h4>
                            <div class="px-xl-3">
                                <a href="bookmark.php?com_email=<?php echo $email; ?>&&com_id=<?php echo $user['company_id']; ?>"
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h5 style="color:orange;">To: <?php echo $email;?>
                                ...
                                <table cellspacing="15">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:450px;vertical-align:top;">
                                            ...
                                            <input type="hidden" class="form-control mb-4" name="com_email"
                                                value="<?php echo $email;?>">
                                            <input type="hidden" class="form-control mb-4" name="skill_list"
                                                value="<?php echo $skill_list;?>">
                                            <input type="hidden" class="form-control mb-4" name="com_name"
